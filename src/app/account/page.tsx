...
export default function AccountPage() {
  const { isLoggedIn, getJwtToken, isAuthLoaded, loggedUser } = useAuth();
      ...
      { isAuthLoaded && isLoggedIn &&
        <div className="flex justify-center items-center flex-col">
          <div className="bg-white shadow-md rounded-lg p-6 my-4 h-[50%] w-[90%] md:w-[80%] flex justify-evenly">
              ...
              {!loggedUser.eventOrganizer &&<ReusableLink href="/account?tab=tickets"  color="#000000" colorHover="#888888" textColor="#FFFFFF">Transactions</ReusableLink>}
          </div>
